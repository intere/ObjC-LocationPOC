...
#define SERIALIZE_APP_VERSION @"appVersion"
#define SERIALIZE_LOG @"log"
...
-(NSDictionary *)toDictionary {
	...
	[Serializer setDict:dict object:self.appVersion forKey:SERIALIZE_APP_VERSION];
	[Serializer setDict:dict object:[TrackLog toArrayOfDictionaries:self.log] forKey:SERIALIZE_LOG];
...
+ (Track *)fromDictionary:(NSDictionary *)dict {
	...
	object.appVersion = [Serializer safeGetDictString:dict withKey:SERIALIZE_APP_VERSION];
	object.log = [TrackLog fromArrayOfDictionaries:[Serializer getArrayFromDict:dict forKey:SERIALIZE_LOG]];
	return object;
}
